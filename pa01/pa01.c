...
// int *readKeyFile(char *fileName) 
//
// Purpose:          reads the files contents   
// Output:           prints errors and the key matrix formatted correctly  
// Argunments:       char *fileName is the file to be read   
// Postcondition:    returns an array with the information from the key file     
//********************************************************
int *readKeyFile(char *fileName) 
{
    ...
    int n; 
    fscanf(file1, "%d", &n); //reads first number from key file  
...
// int readTextFile(int *keyFile, char *fileName) 
//
// Purpose:          reads the plain text files contents, and calls simplifyFormat   
// Output:           prints errors    
// Argunments:       char *fileName is the file to be read, int *keyFile is the array with the info about the key   
...
// int simplifyFormat(int *keyFile, char *textFile, int textLength)  
//
// Purpose:          removes non letter chars and numbers, converts all chars to lowercase, adds padding xs, converts the chars to numbers, calls multiplyMatrixes 
// Output:           prints errors and the plaintext formatted correctly 
// Argunments:       int *keyFile is the array with info of the key, char *textFile is the array with info of the plaintext, textLength is the length of the plaintext array   
// Postcondition:    returns 1 or 0      
//********************************************************
int simplifyFormat(int *keyFile, char *textFile, int textLength) 
{  
...
//
// Purpose:          reads the plain text files contents, and calls simplifyFormat   
// Output:           prints errors and the ciphertext fomatted correctly 
// Argunments:       int *keyFile is the array with info of the key, char *numFile is the array with the plaintext in number format, textLength is the length of the plaintext array    
// Postcondition:    returns 1 or 0      
//********************************************************
int multiplyMatrixes(int *keyFile, int *numFile, int textLength) 
{
    ...
    {
        for(int j = 0; j < n; j++) //adds numbers to a block 
        {
            block[j] = numFile[i + j];  
        } 
